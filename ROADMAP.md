...
| **The Windows mutation suite is red and holds the cut** — a path-string test comparison, and a re-materialization reported as a write where no POSIX mode is observable | `DC-87-…/windows-mutation-suite-red-handoff-v1.md` |
| ~~**0.43.0 release preparation**~~ **sweep accepted 2026-09-16** (`9253dee4`, `3e5bb3c0`); the release commit waits on green CI and is redone with that day's date | `119-…/release-0.43.0-prep-handoff-v1.md` |
