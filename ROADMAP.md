...
| **0.42.0 release position (2026-09-13, evening)** | | | **Theme delivered**: RFC 151 in full, plus the lifecycle gate, the CI policy job with required steps, `size-check`, the layer rule, the derived crate order. **Both stikk rounds landed (`bf36b2ee`, `ee096fd3`, `804b3b51`).** **Prep ACCEPTED 2026-09-13** (`ace23690`, `d97e467e`): sweep found three docs homes missing and the CHANGELOG's breaking-once line; memory ratio 6.24× vs 6.26× prior; 49-check smoke. **Cutting.** |
