...
- [`152-release-authority-in-v0.md`](rfcs/proposed/152-release-authority-in-v0.md) — RFC 152, Release authority in v0 (opened 2026-09-13 on the owner's ruling that DC-35's rules are useless to a one-owner project and must be revised). The owner is the release authority, the architect executes, the tag key is the signer set, quorum/hold/break-glass are v1 governance. **Awaits acceptance.**
...
| ~~**16**~~ | ~~DC-43's no-authority half~~ | Tooling / CI | **Refused by the owner 2026-09-13.** DC-35's rules ruled useless for v0 → **RFC 152** revises release authority; DC-43 held until then, then archived |
