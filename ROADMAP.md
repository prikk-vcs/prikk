...
| **RFC 149 §5.2b + §4b** — the 41-item `pub` list; the notice to stikk | `rfcs/accepted/149-…` | **two decisions, ready now**; architect recommends yes to both |
