...
| **1** | **RFC 144 §4p.2 — say what a declaration became** | Product | **RULED 2026-09-09; handed off** at `rfcs/handoffs/144-two-point-comparison/increment-3-piece-1-declaration-disclosure-handoff-v1.md`. **§4o.2's refusal rule was narrower than its own justification**: `prikk mv` into an ignore-matched path authors `delete-file` and says nothing. The outcome is right — the silence is not. Disclosure, not refusal |
