...
- [`158-large-objects.md`](rfcs/proposed/158-large-objects.md) — large objects: an import bound, streaming, content-defined chunk manifests (format 8) and explicit reclamation; proposed 2026-09-21 on the owner's word, after measurement
...
(`prikk diff`, amended by its §7; owner-accepted 2026-09-17; handed off for 0.46.0) and **157** (`prikk tree` and
`prikk cat`, a tree listing and a file's bytes at a point; owner-accepted 2026-09-17; handed off for 0.46.0). **140 left `accepted/` for `done/` at
