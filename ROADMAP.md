...
| **0.43.0 release preparation** (readiness sweep, the release commit, plus the two declaration parity rows owed from RFC 147 §2f's review) | `119-…/release-0.43.0-prep-handoff-v1.md` |
