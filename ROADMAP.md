...
| **7 (0.42.0)** | **RFC 149 — layer `prikk-store`: core stays, 26 surfaces move to `prikk-operations`** | Product | **ACCEPTED 2026-09-12; name `prikk-operations`; gate before the cut.** Steps 1–2 handed off (`149-…/step-1-2-graph-and-census-handoff-v1.md`): graph confirmation and the census of core items the surfaces reach — the owner then rules on that list (§5.2) before any move |
...
| **9 (0.42.0, first)** | RFC 130 §8 — `size-check`: production file over 1,200 lines fails unless allowlisted with a reason and `what_would_split_it`; production-line delta reported; RFC 141 evidence gains the size line | Tooling | **RULED 2026-09-12 (before the cut); handed off** — `130-…/size-check-handoff-v1.md`. Three files enter the allowlist today |
| **10 (0.42.0 prep)** | Help-versus-inventory check beside RFC 146 §8e | Tooling | **Handed off** — `146-…/help-inventory-check-handoff-v1.md` |
...
| ~~**RFC 149**~~ — layer `prikk-store` | `rfcs/accepted/149-…` | **accepted 2026-09-12**: `prikk-operations`, gate before; next owner decision is the census list (§5.2) |
