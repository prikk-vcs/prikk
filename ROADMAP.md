...
| ~~RFC 131 §6e — grouping census~~ **DONE 2026-09-12** (`60f17dcf` step 0; census reviewed; §6f ruled: A first, C second, B refused by measurement). **`rollback/` grouping DONE (`05ac6b29`); next `merge/` — `131-…/merge-grouping-handoff-v1.md`.** Was: grouping census, **with step 0: `boundary-check --graph`** (the gate emits no graph today; the handoff had assumed it did — corrected) | `131-…/grouping-census-handoff-v1.md` |
