...
| **1** | **RFC 131 §6c.4 — subtree-aware cycle detection** | Product | **RULED 2026-09-10; handed off** at `rfcs/handoffs/131-module-grouping-and-visibility-scoping/subtree-aware-cycles-handoff-v1.md`. Keep qualified nodes; compute cycles over **subtrees** (A ↔ B when any descendant of A depends on any descendant of B and back); report at the **smallest exhibiting pair**; an edge to a node's own ancestor or descendant contributes nothing — which is what keeps the **35 files that reference their own parent absolutely** from becoming 2-cycles. **All 8 declared cycles and 5 hub changes held** until re-measured |
