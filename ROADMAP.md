...
| **0** | **Remove the retired `PRIKK_*_SEED` detection** — RFC 148 rule 1's window ends; `legacy_variable_set` goes with it before the schema publishes | Product | **Handed off** — `148-…/retire-legacy-seed-detection-handoff-v1.md` (unblocked by 0c) |
