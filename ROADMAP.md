...
`prikk cat`, a tree listing and a file's bytes at a point; owner-accepted 2026-09-17; handed off for 0.46.0) and **158** (large objects: a bound, streaming, chunk manifests as format 8, and `prikk reclaim`; owner-accepted 2026-09-21, unimplemented, from 0.47.0). **140 left `accepted/` for `done/` at
