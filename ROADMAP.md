...
| **RFC 149 §6e — cut anyway (A) or layer-as-gate-rule (B)** | `rfcs/accepted/149-…` | **ready now**; architect recommends B. RFC 141 §7a is closed (`063c3e77`); the team is idle until this is ruled |
| ~~**RFC 150**~~ — `prikk key status` | `rfcs/accepted/150-…` | **accepted 2026-09-12**; handoff live; 0.41 item 0 sequenced behind it |
| **`branch switch` / current-branch pointer** | DC-61, `--help` | a direction, before any RFC |
