...
| **0c** | **RFC 150 `prikk key status`** — signing readiness for front-ends, per stikk letter 007 | Product | **ACCEPTED 2026-09-12; handoff live** — `150-signing-readiness/key-status-handoff-v1.md`. **Item 0's removal waits for this** |
