...
- [Worktree Patch Authoring](guide/patches/worktree-patch.md)
  ...
  - [Supported Patch Inverse Planning](guide/patches/patch-inverse.md)
- [Rollback Preview](guide/rollback/rollback-preview.md)
  - [Rollback Draft](guide/rollback/rollback-draft.md)
