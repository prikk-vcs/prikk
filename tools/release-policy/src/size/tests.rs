...
/// one that exists: `node_authoring.rs` is 1,415 physical lines with a 49-line `mode_change_tests`
/// module at the end, and the gate must see 1,366. Counting the test module would not change this
...
fn an_inline_test_module_is_not_production() {
    ...
    assert_eq!(counted.production_lines, 1366);
    assert_eq!(
