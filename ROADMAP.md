...
| **17 — unscheduled (after RFC 154/155)** | **RFC 113 — history import foundations**: the import contract on prikk's side, ruled 2026-09-13 (importer signs the import; only an adopted maintainer seals; refuse-not-approximate Git floor); then Git, then Subversion, then CVS; brygge decodes | Product | **Awaits the owner's scheduling** |
